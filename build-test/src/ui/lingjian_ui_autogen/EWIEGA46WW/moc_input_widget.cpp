...
Q_CONSTINIT static const qt_meta_stringdata_InputWidget_t qt_meta_stringdata_InputWidget = {
    {
        ...
        QT_MOC_LITERAL(12, 18),  // "chineseModeChanged"
        QT_MOC_LITERAL(31, 0),  // ""
        QT_MOC_LITERAL(32, 2)   // "on"
    },
    "InputWidget",
    "chineseModeChanged",
    "",
...
void InputWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->chineseModeChanged((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (InputWidget::*)(bool );
            if (_t _q_method = &InputWidget::chineseModeChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void InputWidget::chineseModeChanged(bool _t1)
{
